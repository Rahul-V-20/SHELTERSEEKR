...
it looks like:
<script src="https://maps.googleapis.com/maps/api/js?key={insert your apikey here}&libraries=places&callback=initAutocomplete" async defer></script>
...
step5) now the code is ready to run. you can run the app.py file
 ...
 https://github.com/Rahul-V-20/SHELTERSEEKR/assets/142727705/9d8c5701-ec8b-4537-acf6-65ae34004e6e
